<template>
  <div>
    <ul class="pages">
      <li class="chat page">
        <div class="chatArea" v-bind:style="{ 'background-color': color }">
...
export default {
  ...
  methods: {
	...
	bunt () {
		console.log('send bunt')
		socket.emit('send-color', '#aa0000')
	},
    scrollToBottom () {
      this.$nextTick(() => {
